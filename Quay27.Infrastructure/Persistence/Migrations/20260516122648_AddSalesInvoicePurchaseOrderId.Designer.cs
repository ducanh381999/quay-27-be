...
namespace Quay27.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260516122648_AddSalesInvoicePurchaseOrderId")]
    partial class AddSalesInvoicePurchaseOrderId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quay27.Domain.Entities.SalesReturn", b =>
                {
                    ...
                    b.Property<Guid?>("RefundReceivingAccountId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("RefundReceivingAccountId");
            ...
            modelBuilder.Entity("Quay27.Domain.Entities.SalesReturn", b =>
                {
                    ...
                    b.HasOne("Quay27.Domain.Entities.ReceivingAccount", "RefundReceivingAccount")
                        .WithMany()
                        .HasForeignKey("RefundReceivingAccountId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("RefundReceivingAccount");
